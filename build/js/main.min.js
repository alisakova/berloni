...
$(document).ready(function(){$(".reviews-slider").length&&$(".reviews-slider").slick({infinite:!0,speed:500,fade:!0})}),$("._open-success-call-modal").click(function(e){return e.preventDefault(),$("#success-modal").modal(),!1}),$("._open-calc-modal").click(function(e){return e.preventDefault(),$("#success-calc-modal").modal(),!1});
