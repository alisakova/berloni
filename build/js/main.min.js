...
$(document).ready(function(){$(".reviews-slider").length&&$(".reviews-slider").slick({infinite:!0,speed:500,fade:!0})}),$("._open-success-call-modal").click(function(c){return c.preventDefault(),$("#success-modal").modal(),!1}),$("._open-calc-modal").click(function(c){return c.preventDefault(),$("#success-calc-modal").modal(),!1});var characteristicsBlocks=document.querySelectorAll(".characteristics"),showMoreBtns=document.querySelectorAll("._show-more-btn"),body=document.querySelector("body");showMoreBtns.forEach(function(t){t.addEventListener("click",function(c){c.stopPropagation();var e=t.nextElementSibling;characteristicsBlocks.forEach(function(c){c.classList.contains("active")&&c!==e&&c.classList.remove("active")}),e.classList.toggle("active")})}),body.addEventListener("click",function(c){c.stopPropagation(),characteristicsBlocks.forEach(function(c){c.classList.contains("active")&&c.classList.remove("active")})});
